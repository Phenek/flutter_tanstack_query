...
```dart
// Get QueryClient from hooks
final queryClient = useQueryClient();

queryClient.invalidateQueries(queryKey: ['todos']);

// Both queries below will be invalidated
final todoListQuery = useQuery<List<dynamic>>(queryKey: ['todos'], queryFn: fetchTodoList);
final todoListQuery2 = useQuery<List<dynamic>>(queryKey: ['todos', {'page': 1}], queryFn: fetchTodoList);
```
...
final todoListQuery = useQuery<List<dynamic>>(queryKey: ['todos', {'type': 'done'}], queryFn: fetchTodoList);

// However, the following query below will NOT be invalidated
final todoListQuery2 = useQuery<List<dynamic>>(queryKey: ['todos'], queryFn: fetchTodoList);
```
...
// However, the following query below will NOT be invalidated
final todoListQuery2 = useQuery<List<dynamic>>(queryKey: ['todos', {'type': 'done'}], queryFn: fetchTodoList);
```
...
queryClient.invalidateQueries(
  predicate: (query) =>
    query.queryKey[0] == 'todos' && ((query.queryKey[1] as Map?)?['version'] ?? 0) >= 10,
);

// The query below will be invalidated
final todoListQuery = useQuery(
  queryKey: ['todos', {'version': 20}],
  queryFn: fetchTodoList,
);

// The query below will be invalidated
final todoListQuery2 = useQuery(
  queryKey: ['todos', {'version': 10}],
  queryFn: fetchTodoList,
);

// However, the following query below will NOT be invalidated
final todoListQuery3 = useQuery(
